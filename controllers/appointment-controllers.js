...
import { getAllAppointmentService, getOneAppointmentService, createAppointmentService, updateAppointmentService, deleteAppointmentService } from '../services/appointment-service.js'
...
export const getOneAppointment = catchAsync(async (req, res) => {
      const appointment = await getOneAppointmentService(req.params.id);
      res.status(200).json({
            status: "success",
            data: appointment
      })
